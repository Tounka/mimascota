...
export const usuario = {
    data: {
      ...
      fechaCreacionPerfil: '2023-10-15', // Fecha de creación del perfil
    },
    mascotas: [
      {
        nombre: 'Rex',
        ...
        relacion: 'Amigo fiel',
        user: 'Carlos',
        img: 'https://images.ctfassets.net/denf86kkcx7r/4IPlg4Qazd4sFRuCUHIJ1T/f6c71da7eec727babcd554d843a528b8/gatocomuneuropeo-97', // Representación de un archivo de imagen
        fechaNacimiento: '2020-05-15', // Fecha de nacimiento de la mascota 1
      },
      {
        nombre: 'Luna',
        raza: 'Labrador',
        relacion: 'Compañera leal',
        user: 'Carlos',
        img: 'https://images.ctfassets.net/denf86kkcx7r/4IPlg4Qazd4sFRuCUHIJ1T/f6c71da7eec727babcd554d843a528b8/gatocomuneuropeo-97', // Representación de un archivo de imagen
        fechaNacimiento: '2018-11-23', // Fecha de nacimiento de la mascota 2
      }
    ]
  };
